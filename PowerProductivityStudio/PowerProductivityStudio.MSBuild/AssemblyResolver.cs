...
public class AssemblyResolver : IAssemblyResolver
{
    ...
    public AssemblyResolver(NotifyUserCodeWeaverTask config, BuildEnginePropertyExtractor buildEnginePropertyExtractor)
    {
        this.config = config;
    ...
    public void Execute()
    {
        ...
        if (string.IsNullOrWhiteSpace(config.References))
        {
            ...
            {
                throw new Exception(string.Format(@"Tried to extract references from the BuildEngine. 
